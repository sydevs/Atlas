...
Passwordless.timeout_at = lambda { 1.day.from_now } # How long until a magic link expires.

# Passwordless.restrict_token_reuse = true # TODO: Reenable?
Passwordless.default_from_address = 'Sahaj Atlas <contact@sydevelopers.com>'
